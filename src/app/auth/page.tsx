...
import { Brain, ArrowRight, Zap, CheckSquare, BookOpen, Calendar, BarChart2, Loader2 } from "lucide-react";
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      const res = await fetch("/api/auth", {
        ...
        body: JSON.stringify({ action: "login", name: trimmed }),
      });
    ...
    <div className="w-full max-w-sm">
      ...
      <p className="text-sm text-muted-foreground mb-6">
        {isReturning
          ...
          : "Enter your name to set up your personal workspace."}
      </p>
